...
Aladdin::Aladdin(int life) : BaseObject(eID::ALADDIN)
{
	_canJumpDown = true;
}
...
void Aladdin::init()
{
	...
	_sprite->setFrameRect(SpriteManager::getInstance()->getSourceRect(eID::ALADDIN, "normal_01"));
	...
	_animations[eStatus::NORMAL]->addFrameRect(eID::ALADDIN, "normal_01", NULL);

	_animations[eStatus::NORMAL | eStatus::SHOOTING] = new Animation(_sprite, 0.1f);
	_animations[eStatus::NORMAL | eStatus::SHOOTING]->addFrameRect(eID::ALADDIN, "normal_01", "normal_02", "normal_03", NULL);

	_animations[eStatus::RUNNING] = new Animation(_sprite, 0.12f);
	_animations[eStatus::RUNNING]->addFrameRect(eID::ALADDIN, "run_01", "run_02", "run_03", "run_04", "run_05", "run_06", "run_07", "run_08", NULL);

	_animations[eStatus::JUMPING] = new Animation(_sprite, 0.15f);
	_animations[eStatus::JUMPING]->addFrameRect(eID::ALADDIN, "jump_01", "jump_02", "jump_03", "jump_04", "jump_05", "jump_06", "jump_07", "jump_08", NULL);


	_animations[eStatus::FALLING] = new Animation(_sprite, 0.1f);
	_animations[eStatus::FALLING]->addFrameRect(eID::ALADDIN, "run_03", NULL);

	_animations[eStatus::LAYING_DOWN] = new Animation(_sprite, 0.1f);
	_animations[eStatus::LAYING_DOWN]->addFrameRect(eID::ALADDIN, "lay_down_01", NULL);

	//_animations[eStatus::LOOKING_UP] = new Animation(_sprite, 0.1f);
	//_animations[eStatus::LOOKING_UP]->addFrameRect(eID::ALADDIN, "shot_up_01", NULL);
	...
	//_animations[eStatus::LOOKING_UP | eStatus::RUNNING]->addFrameRect(eID::ALADDIN, "run_shot_up_01", "run_shot_up_02", "run_shot_up_03", NULL);

	//_animations[eStatus::LAYING_DOWN | eStatus::RUNNING] = new Animation(_sprite, 0.12f);
	//_animations[eStatus::LAYING_DOWN | eStatus::RUNNING]->addFrameRect(eID::ALADDIN, "run_shot_down_01", "run_shot_down_02", "run_shot_down_03", NULL);

	//_animations[eStatus::SHOOTING | eStatus::RUNNING] = new Animation(_sprite, 0.12f);
	//_animations[eStatus::SHOOTING | eStatus::RUNNING]->addFrameRect(eID::ALADDIN, "run_shot_01", "run_shot_02", "run_shot_03", "run_shot_01", "run_shot_02", "run_shot_03", NULL);

	//_animations[eStatus::SWIMING] = new Animation(_sprite, 0.2f, false);
	//_animations[eStatus::SWIMING]->addFrameRect(eID::ALADDIN, "swim_begin", "diving", "swimming", "swimming_01", NULL);
	//_animations[eStatus::SWIMING]->animateFromTo(0, 2, false);

	//_animations[eStatus::DIVING] = new Animation(_sprite, 0.2f, false);
	//_animations[eStatus::DIVING]->addFrameRect(eID::ALADDIN, "swim_begin", "diving", "diving_01", NULL);
	...
	//_animations[eStatus::SWIMING | RUNNING | SHOOTING]->addFrameRect(eID::ALADDIN, "swim_begin", "swimming_shot", "swimming_shot_01", NULL);
	...
	//_animations[eStatus::SWIMING | SHOOTING]->addFrameRect(eID::ALADDIN, "swim_begin", "swimming_shot", "swimming_shot_01", NULL);
	...
	//_animations[eStatus::SWIMING | RUNNING | LOOKING_UP | SHOOTING]->addFrameRect(eID::ALADDIN, "swim_begin", "swimming_shotup", "swimming_shotup_01", NULL);
	...
	//_animations[eStatus::SWIMING | LOOKING_UP | SHOOTING]->addFrameRect(eID::ALADDIN, "swim_begin", "swimming_shotup_stand", "swimming_shotup_stand_01", NULL);
	...
	//_animations[eStatus::DYING]->addFrameRect(eID::ALADDIN, "dead_01", "dead_02", "dead_03", "dead_04", NULL);
...
void Aladdin::draw(LPD3DXSPRITE spriteHandle)
{
	if (_protectTime > 0)
	{
...
{
	float AladdinPositionX = this->getPositionX();
	auto halfwidth = this->getSprite()->getFrameWidth() * this->getSprite()->getOrigin().x;
	// Không cho đi vượt cạnh trái
	if (AladdinPositionX + halfwidth - _movingSpeed * 0.33 <= 0) // hard code
	{
...
void Aladdin::falling()
{
	auto gravity = (Gravity*)this->_componentList["Gravity"];
	gravity->setStatus(eGravityStatus::FALLING__DOWN);
}
void Aladdin::setStatus(eStatus status)
{
...
eDirection Aladdin::getAimingDirection()
{
